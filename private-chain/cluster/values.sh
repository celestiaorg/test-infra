...
#export WORKER_NODE_TYPE=c5.4xlarge # 16CPU/32RAM
#export WORKER_NODE_TYPE=c5.9xlarge # 36CPU/72RAM
#export WORKER_NODE_TYPE=c5a.24xlarge # 96CPU/192RAM
#export MASTER_NODE_TYPE=c5.9xlarge # 36CPU/72RAM
#export MASTER_NODE_TYPE=c5.4xlarge # 16CPU/32RAM
#
