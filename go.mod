...
replace (
	...
	github.com/celestiaorg/celestia-app => github.com/Bidon15/lazyledger-app v1.0.1-dirty-app
	github.com/cosmos/cosmos-sdk => github.com/Bidon15/cosmos-sdk v1.0.2-dirty-sdk-v0.44.2
