...
replace (
	github.com/celestiaorg/celestia-node => github.com/derrandz/celestia-node v0.6.3-0.20230311140423-894e3a6ec124
...
require (
	...
	github.com/celestiaorg/celestia-node v0.7.0-rc9
